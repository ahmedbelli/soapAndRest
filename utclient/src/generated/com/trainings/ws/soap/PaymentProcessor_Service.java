 ...
 * 2017-09-04T10:17:49.415-05:00
 * Generated source version: 3.0.2
 * 
 */
@WebServiceClient(name = "PaymentProcessor", 
                  wsdlLocation = "file:/E:/Programming/workspaces/SoapAndRest/utclient/src/main/resources/paymentProcessor.wsdl",
...
public class PaymentProcessor_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/E:/Programming/workspaces/SoapAndRest/utclient/src/main/resources/paymentProcessor.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(PaymentProcessor_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/E:/Programming/workspaces/SoapAndRest/utclient/src/main/resources/paymentProcessor.wsdl");
        }
        WSDL_LOCATION = url;
    }
